...
Version 2024-07-28
==================
* Added 42 new airports and fixed 58 ones:
...
Detail of changes
^^^^^^^^^^^^^^^^^
* Added the following 41 airports:
  ...
  - VECX/KNU, Kanpur Airport, Kanpur, Uttar Pradesh, IN.
...
* Updated ICAO (and potentially other data) for the following airport:
...
* Updated other data for the following 42 airports:
  ...
  - CYWH/YWH, Victoria Harbour Airport, Victoria, British Columbia, CA: name changed from "Victoria Harbour BC (Water
    Seaplane Base)", latitude changed from 48.42283 to 48.41667, longitude changed from -123.3875 to -123.366667.
